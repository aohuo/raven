...
// Repository setup: keep local database credentials in the ignored root .env file.
return [
    // 数据库类型
    'type'            => 'mysql',
    // 服务器地址
    ...
    // 数据库名
    'database'        => \think\Env::get('database.database', 'order'),
    // 用户名
    ...
    'prefix'          => '',
    // 数据库调试模式
    'debug'           => (bool) \think\Env::get('app_debug', 0),
